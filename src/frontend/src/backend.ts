...
export class Backend implements backendInterface {
    ...
    async getPaymentCount(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getPaymentCount();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async recordPayment(arg0: string, arg1: string, arg2: number, arg3: string): Promise<bigint> {
        if (this.processError) {
            try {
